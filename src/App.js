...
class BooksApp extends React.Component {
  constructor (props) {
    super(props);
    // setting the state with the books result
  ...
  /**
   * Update a book's shelf or Add it to the Library in a shelf
   */
    ...
    return (
      <div className="app">
        ...
        <Route
          ...
          render={ () => (
            //Library Page
            <Library books={ books } updateBookShelf={ this.updateBookShelf } />
          ) }
        />
      </div>
    );
